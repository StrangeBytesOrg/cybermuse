...
-- +goose Down
-- reverse: create "generate_presets" table
DROP TABLE `generate_presets`;
-- reverse: create "prompt_templates" table
DROP TABLE `prompt_templates`;
-- reverse: create "message_contents" table
DROP TABLE `message_contents`;
-- reverse: create "messages" table
DROP TABLE `messages`;
-- reverse: create "chat_characters" table
DROP TABLE `chat_characters`;
-- reverse: create "chats" table
DROP TABLE `chats`;
